    ...
    <section class="card help-card">
      <details>
        ...
        <div class="help-card__content">
          <p class="help-card__text">${t("nodes.help.description")}</p>
          
          <div class="help-card__section">
            <strong>${t("nodes.help.useCases")}</strong>
            <ul class="help-card__list">
              <li>${t("nodes.help.useCase1")}</li>
              <li>${t("nodes.help.useCase2")}</li>
              <li>${t("nodes.help.useCase3")}</li>
            </ul>
          </div>
          
          <div class="help-card__section">
            <strong>${t("nodes.help.howToPair")}</strong>
            <p class="help-card__text" style="white-space: pre-line;">${t("nodes.help.pairSteps")}</p>
          </div>
        </div>
      </details>
    </section>
    ...
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
          ...
          <div class="card-sub">${t("nodes.nodesDesc")}</div>
        </div>
    ...
    <div class="list-item">
      <div class="list-main">
        ...
        <div class="muted" style="margin-top: 6px;">
          ${role} · ${t("nodes.requested", { time: age })}${repair}
        </div>
      </div>
      <div class="list-meta">
...
function getSecurityOptions(): Array<{ value: ExecSecurity; label: string }> {
  return [
    { value: "deny", label: t("nodes.deny") },
    { value: "allowlist", label: t("nodes.allowlist") },
    { value: "full", label: t("nodes.full") },
  ];
}

function getAskOptions(): Array<{ value: ExecAsk; label: string }> {
  return [
    { value: "off", label: t("nodes.askOff") },
    { value: "on-miss", label: t("nodes.askOnMiss") },
    { value: "always", label: t("nodes.askAlways") },
  ];
}
            ...
            <div class="list" style="margin-top: 16px;">
              <div class="list-item">
                <div class="list-main">
                  ...
                  <div class="list-sub">${t("nodes.defaultBindingDesc")}</div>
                </div>
                <div class="list-meta">
                  <label class="field">
                  ...
                  ${
                    !supportsBinding
                      ? html`<div class="muted">${t("nodes.noNodesWithSystemRun")}</div>`
                      : nothing
                  }
                </div>
              </div>
...
export function renderExecApprovals(state: ExecApprovalsState) {
  ...
  return html`
    <section class="card">
      <div class="row" style="justify-content: space-between; align-items: center;">
        <div>
          <div class="card-title">${t("nodes.execApprovals")}</div>
          <div class="card-sub">
            ${t("nodes.execApprovalsDesc")}
          </div>
        </div>
        <button
          class="btn"
      ...
      ${
        !ready
          ? html`<div class="row" style="margin-top: 12px; gap: 12px;">
            <div class="muted">${t("nodes.loadApprovalsHint")}</div>
    ...
    <div class="list" style="margin-top: 12px;">
      ...
      ${
        state.target === "node" && !hasNodes
          ? html`<div class="muted">${t("nodes.noNodesAdvertise")}</div>`
          : nothing
      }
    </div>
  `;
    ...
    <div class="list" style="margin-top: 16px;">
      <div class="list-item">
        <div class="list-main">
          ...
          <div class="list-sub">
            ${
              isDefaults
                ? t("nodes.securityModeDefault")
                : `${t("common.default")}: ${defaults.security}.`
            }
          </div>
        </div>
        <div class="list-meta">
          <label class="field">
            <span>${t("nodes.mode")}</span>
            <select
              ?disabled=${state.disabled}
              @change=${(event: Event) => {
                const target = event.target as HTMLSelectElement;
              ...
              ${
                !isDefaults
                  ? html`<option value="__default__" ?selected=${securityValue === "__default__"}>
                    ${t("nodes.useDefaultWith", { value: defaults.security })}
                  </option>`
                  : nothing
              }
              ${securityOptions.map(
      ...
      <div class="list-item">
        <div class="list-main">
          ...
          <div class="list-sub">
            ${isDefaults ? t("nodes.askPolicyDefault") : `${t("common.default")}: ${defaults.ask}.`}
          </div>
        </div>
        <div class="list-meta">
          <label class="field">
              ...
              ${
                !isDefaults
                  ? html`<option value="__default__" ?selected=${askValue === "__default__"}>
                    ${t("nodes.useDefaultWith", { value: defaults.ask })}
                  </option>`
                  : nothing
              }
              ${askOptions.map(
      ...
      <div class="list-item">
        <div class="list-main">
          ...
          <div class="list-sub">
            ${
              isDefaults
                ? t("nodes.askFallbackDesc")
                : `${t("common.default")}: ${defaults.askFallback}.`
            }
          </div>
        </div>
        <div class="list-meta">
          <label class="field">
            <span>${t("nodes.fallback")}</span>
            <select
              ?disabled=${state.disabled}
              @change=${(event: Event) => {
                const target = event.target as HTMLSelectElement;
              ...
              ${
                !isDefaults
                  ? html`<option value="__default__" ?selected=${askFallbackValue === "__default__"}>
                    ${t("nodes.useDefaultWith", { value: defaults.askFallback })}
                  </option>`
                  : nothing
              }
              ${securityOptions.map(
      ...
      <div class="list-item">
        <div class="list-main">
          <div class="list-title">${t("nodes.autoAllowSkillCLIs")}</div>
          <div class="list-sub">
            ${
              isDefaults
                ? t("nodes.autoAllowSkillCLIsDesc")
                : autoIsDefault
...
function renderExecApprovalsAllowlist(state: ExecApprovalsState) {
  ...
  return html`
    <div class="row" style="margin-top: 18px; justify-content: space-between;">
      <div>
        <div class="card-title">${t("nodes.allowlistTitle")}</div>
        <div class="card-sub">${t("nodes.allowlistDesc")}</div>
      </div>
      <button
        class="btn btn--sm"
        ?disabled=${state.disabled}
    ...
    <div class="list" style="margin-top: 12px;">
      ${
        entries.length === 0
          ? html`<div class="muted">${t("nodes.noAllowlistEntries")}</div>`
...
function renderAllowlistEntry(
  ...
  const lastUsed = entry.lastUsedAt ? formatAgo(entry.lastUsedAt) : t("nodes.never");
  ...
  return html`
    <div class="list-item">
      <div class="list-main">
        ...
        <div class="list-sub">${t("nodes.lastUsed")}: ${lastUsed}</div>
        ${lastCommand ? html`<div class="list-sub mono">${lastCommand}</div>` : nothing}
        ${lastPath ? html`<div class="list-sub mono">${lastPath}</div>` : nothing}
      </div>
      <div class="list-meta">
        <label class="field">
          <span>${t("nodes.pattern")}</span>
          <input
            type="text"
            .value=${entry.pattern ?? ""}
            ?disabled=${state.disabled}
        ...
        <div class="list-sub">
          ...
          ${
            bindingValue === "__default__"
              ? t("nodes.usesDefault", { value: state.defaultBinding ?? t("nodes.anyNode") })
              : t("nodes.overrideBinding", { value: agent.binding ?? "" })
          }
        </div>
      </div>
      <div class="list-meta">
    ...
    <div class="list-item">
      <div class="list-main">
        ...
        <div class="chip-row" style="margin-top: 6px;">
          <span class="chip">${paired ? t("nodes.paired") : t("nodes.unpaired")}</span>
          <span class="chip ${connected ? "chip-ok" : "chip-warn"}">
            ${connected ? t("common.connected") : t("nodes.offline")}
          </span>
