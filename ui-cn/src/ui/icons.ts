...
export const icons = {
  ...
  // Key icon (for API keys / env vars)
  key: html`
    <svg viewBox="0 0 24 24">
  ...
  phoneOff: html`
    <svg viewBox="0 0 24 24">
      <path
        d="M10.68 13.31a16 16 0 0 0 3.41 2.6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.42 19.42 0 0 1-3.33-2.67"
      />
      <path d="M10.68 13.31 2 2" />
      <path d="M22 2 13.31 10.68" />
      <path d="M4.11 2H7a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91" />
    </svg>
  `,
  // Gallery / grid icon
  grid: html`
  ...
  // Conversation sidebar & compose-card icons
  pin: html`
    <svg
  ...
  `,
  // Eye icons (Lucide "eye" / "eye-off") — password visibility toggle
  eye: html`
    <svg viewBox="0 0 24 24">
  ...
  `,
  // Network / networking center icon (Lucide "network")
  network: html`
    <svg viewBox="0 0 24 24">
